...
import type { ServiceManifest, HealthResult } from "./types.js";

export function checkHealth(manifest: ServiceManifest): HealthResult {
...
export function checkAllHealth(manifests: ServiceManifest[]): HealthResult[] {
